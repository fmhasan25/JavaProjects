...
public class Actionitem_kayak {
    ...
    public void defineDriver() throws IOException, BiffException {
        ...
        readableFile = Workbook.getWorkbook(new File("src/Resource/Kayak.xls"));
        //Define the readable sheet
        readableSheet = readableFile.getSheet(0);
        //Define the path to create writable file
        writableFile = Workbook.createWorkbook(new File("src/Resource/KayakResults.xls"), readableFile);
...
//for loop starts
        for (int i = 1; i < row; i++) {
            ...
            Reusable_Library.click(driver, "(//*[@class='_id7 _irc _ii0 _iir']) [2]", "End time");
            //Delay for 3 sec
            Thread.sleep(3000);
            //Scrolling down
