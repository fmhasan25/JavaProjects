...
public class Aetna_actionitem_2 {
...
//Clearing the box and putting zipCode
            ...
            */
            try {
                ...
                Actions actions = new Actions(driver);
                WebElement SourceElement = driver.findElement(By.xpath("//span[@aria-valuenow='25']"));

                WebElement start =driver.findElement(By.xpath("//span[@aria-valuenow='0']"));
                actions.dragAndDrop(SourceElement,start).perform();
                WebElement stop =driver.findElement(By.xpath("//span[@aria-valuenow='10']"));
                actions.dragAndDrop(start, stop).perform();
